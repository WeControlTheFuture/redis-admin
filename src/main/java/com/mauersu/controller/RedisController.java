...
public class RedisController extends RedisApplication implements Constant {
	...
	public Object index(HttpServletRequest request, HttpServletResponse response) {
		...
		String defaultServerName = (String) (RedisApplication.redisServerCache.get(0) == null ? ""
				: RedisApplication.redisServerCache.get(0).getName());
		request.setAttribute("serverName", defaultServerName);
		request.setAttribute("dbIndex", DEFAULT_DBINDEX);
		return "admin/main";
	}
	...
	private Pagination stringListPagination(HttpServletRequest request, String queryKey, String queryKey_ch,
	...
	private Pagination getPagination(HttpServletRequest request) {
		String items_per_page = StringUtil.getParameterByDefault(request, "items_per_page",
